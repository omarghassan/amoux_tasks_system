                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end status-dropdown-menu">
                                        <li>
                                            <div class="dropdown_header">
                                                <p>Task</p>
                                                <div class="task_editing_options">
                                                    <button
                                                        class="dropdown-item edit-task-item d-flex"
                                                        type="button" data-task-id="" data-task-data="">
                                                        <i class="ri-edit-line me-2"></i>
                                                    </button>
                                                    <button
                                                        class="dropdown-item delete-task-item d-flex"
                ...
                <div class="tasks_status_container">
                    ...
                    <div class="task-status-widget">
                        <div class="widget-header">
                            <img class="task_status_image" src="./assets/images/task_status.png"
                    ...
                    <div class="completed_tasks">
                        <div class="completed_tasks_header">
                            <div class="completed_title_container">
                                <img class="task_icon" src="./assets/images/completed_task.png"
                            ...
                            <div class="completed_task_item">
                                <div class="completed_task_content">
                                    <div class="task_details_header">
                                        ...
                                        <!-- Status Dropdown Template for completed tasks -->
                                        <div class="dropdown d-inline-block ms-1">
